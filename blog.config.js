...
const BLOG = {
  ...
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a7
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '392a7ec1dd864fa290437fea1ac8ab7f',
  UUID_REDIRECT: false,
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'typography', // 当前主题,切换为 typography 测试改造效果
  ...
  //    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism.css', // 代码块默认主题 - Notion 风格
  //  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  //  PRISM_THEME_LIGHT_PATH:
  //    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
  //    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism.css', // 浅色模式主题 - Notion 风格
  //  PRISM_THEME_DARK_PATH:
  //    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
  //    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-tomorrow.css', // 深色模式主题 - Notion 风格
  //
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-NmXOroaXwo', // Remove the value or replace it with your own google site verification code
